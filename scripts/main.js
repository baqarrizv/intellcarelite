...
const appnt_new_book="appnt_new_book.html";
const appnt_new="appnt_new.html";
const appnt_view_det="appnt_view_det.html";
const appnt_view="appnt_view.html";
const dash_patient="dash_patient.html";
const demogrp_update="demogrp_update.html";
...
const vitals_view="vitals_view.html";
//objects//
            ...
            if (userName == "interactive@ppl.com") 
            {
                ...
                let response = {
                    ...
                    "activities": [
                        ...
                        {
                            "id": 11,
                            "name": "My Attended Patients",
                            "actions": [
                                {
                                    "id": 16,
                                    "activityId": 11,
                                    "name": "Attended Patient List",
                                    "contents": null
                                },
                                {
                                    "id": 17,
                                    "activityId": 11,
                                    "name": "Send Back Medicine List",
                                    "contents": null
                                }
                            ]
                        }
            ...
            if (navigator.onLine) 
            {
                ...
                if (errCount == 0) 
                {
                    ...
                    if (!response.ok) {
                        ...
                        window.location.replace(dash_patient);
                        // console.log("--------------response.json()----------------------");
                        // console.log(response.json());
                        // response.json()
                        // .then(data => {                
...
async function fetchSpecialtyList(inp_specialty)
{
    ...
    try {
        ...
        // showMessage("processing. please wait.");
        showLoader(1, "fetching specialties");

        const url=rootUrl+"preReqForAppointment";
        console.log("complete url=> "+url);
    ...
    try {
        ...
        if (!response.ok) {
            ...
            .then(data => {                
                ...
                // console.log(data);
                saveMedicationsToOffline(data);
                // mapMedications(data, container2);
                // container2.innerHTML = data.data.map(mapMedications).join('\n\n');
...
function mapSpecialties(specialties)
{
...
function mapDoctors(doctors)
{
    ...
    let dataRow = `<div class="content mt-3">
        <div class="d-flex">
            <div class="align-self-center">
                <h1 class="mb-n1 font-22 font-700">`+name+`</h1>
                <p class="mb-2 pl-2 mb-n1">Dermatologist, Cosmetologist</p>
        ...
        <div class="pl-2 d-flex mb-4">
            <div class="w-35 border-right pr-3 border-red2-dark">
                <h6 class="font-14 font-600 mt-2 text-center">27 Years</h6>
                <p class="color-red2-dark mt-n2 font-9 font-400 text-center mb-0 pb-0">Experience</p>
            </div>
            <div class="pl-2 w-35 border-right pr-3 border-red2-dark">
                <h6 class="font-14 font-600 mt-2 text-center">27 Years</h6>
                <p class="color-red2-dark mt-n2 font-9 font-400 text-center mb-0 pb-0">Experience</p>
            </div>
            <div class="pl-2 w-35 border-right pr-3 border-red2-dark">
...
async function prepareNewAppointment(inp_specialty, container2)
{
    ...
    await fetchSpecialtyList(inp_specialty);
    ...
    try {
        ...
        console.log("prepareNewAppointment => "+error);
    }

    // console.log("specialities => ");
    // console.log(specialties.object.specialities);
    ...
    try {
        ...
        db.person.get(parseInt(window.sessionStorage.getItem("personId")), function(firstPerson)
        {
            ...
            try {
                ...
                const drawer_profile = document.getElementById('drawer_profile');
                const drawer_logout = document.getElementById('drawer_logout');
                ...
                drawer_profile.addEventListener("click", function () 
                {
                    console.log("view ing profile");
                    showtoastMsg(0, "work is in progress");
                });

                drawer_logout.addEventListener("click", function () 
                {
                    console.log("logout");
                    logoutApp();
                    // showtoastMsg();
...
function logoutApp()
{
    ...
    showLoader(1, "signing out. please wait.");
...
function goToAppointmentView()
{
    ...
    window.location.href = appnt_view;
}
...
function setSelectedVitalDetails(vitalId)
{
    ...
    window.location.assign(vitals_view_det);
...
function setSelectedAppointmentDetails(appointmentId)
{
    ...
    window.location.assign(appnt_view_det);
